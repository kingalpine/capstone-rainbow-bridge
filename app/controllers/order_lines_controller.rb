class OrderLinesController < ApplicationController
  ...
  private
    ...
    def order_line_params
      params.require(:order_line).permit(:Order_id, :Product_id, :Order_Line_Status_id, :Order_Line_Start_Date, :Order_Line_Finish_Date, :Order_Line_Description, :Special_Order_Notes)
    end
end
