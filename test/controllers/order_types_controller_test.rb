...
class OrderTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_type" do
    assert_difference('OrderType.count') do
      post order_types_url, params: { order_type: { Order_Description: @order_type.Order_Description } }
    end
  ...
  test "should update order_type" do
    patch order_type_url(@order_type), params: { order_type: { Order_Description: @order_type.Order_Description } }
